            ...
            <div class="container">
                ...
                <header class="py-4">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-xl-4 py-2">
                            <nav class="nav nav-header d-flex justify-content-center align-items-center justify-content-lg-end">
                ...
                <div class="row py-lg-5">
                    <div class="col-lg-6 py-5 text-center text-lg-left">
                        ...
                        <a href="javascript:void(0)" class="btn btn-primary rounded-pill shadow-lg py-3 px-4 px-md-5 m-1">
                            <i class="fa fa-thumbs-up text-white-90 mr-1"></i> Subscribe
                        </a>
                        <a href="javascript:void(0)" class="btn btn-dark rounded-pill shadow-lg py-3 px-4 px-md-5 m-1">
